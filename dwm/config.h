...
static const char normbordercolor[]       = "blue";
static const char normfgcolor[]           = "lightgreen";
static const char selfgcolor[]            = "white";
static const char selbordercolor[]        = "yellow";
static const char selbgcolor[]            = "red";
...
static const char *dmenucmd[] = { 
	...
	"-sb", extra_1, 
	"-sf", selfgcolor, 
	"-hb", "pink",	// High priority background color
    	"-hf", "black",	// High priority foreground color
    	"-hp", "firefox-esr,chromium,codium,freetube", // High priority items
	NULL 
};
